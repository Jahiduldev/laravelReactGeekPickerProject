...
class DailyCurrencyUpdate extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'currencyUpdate:daily';
     ...
     * @var string
     */
    protected $description = 'Respectively send an exclusive rate to everyone daily via email.';
